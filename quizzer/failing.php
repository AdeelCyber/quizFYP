...
<body style="background-color: black;">
    <div>
        <svg  viewBox="0 0 1123 837" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect  fill="black"/>
    ...
    <div style="color:white" class="text">
        <h1>Inspect Element Detected.</h1>  
      <h2>You are seeing this error because inspect tools is opened on this webpage.</h2>
         <h3>All Operations will be terminated. <br>In order to continue, please close Inspect Element and reload the page.</h3> 
    </div>
</body>
</html>
