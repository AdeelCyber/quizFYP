            ...
            <div class="w-full">
              ...
              <label class="block mt-4 text-sm">
                ...
                <select name="grp" id="grp"
                  class="form block w-full mt-1 text-sm bg-gray-100 p-2 rounded-lg focus:border-purple-400 focus:outline-none focus:shadow-outline-purple  form-input"
                >
                <?php $grp = "SELECT * from allowedgroup where isActive=1";
                $q = mysqli_query($mysqli,$grp);
              ...
              <hr class="my-8" />
                 <div><a class="hover:text-green-500" style="float:right;" href="login.php">Already a User? Login</a></div>
            </div>
